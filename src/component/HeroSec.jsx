                    ...
                    <div className="hero_wrapper w-full bg-gradient-to-r from-primary to-secondery rounded-lg flex justify-center">
                        <div className="hero_desc pl-4 w-full">
                            ...
                            <form action="#" className="flex justify-center lg:block">
                                <div className="hero_form_wrap border lg:bg-white-1 border-text-heading-1 mt-6 mb-24 lg:rounded-full inline-flex flex-col items-center lg:justify-between lg:flex-row gap-y-4 w-[77%] border-none lg:border-solid">
